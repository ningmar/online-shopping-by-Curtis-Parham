...
//validating file  and after multiple file is uploaded configuring in similar way
        ...
        //  $photo = $_FILES['photo'];
          ...
          $uploadPath[] = BASEURL.'/ecommerce/images/products/'.$uploadName;
          if ($i != 0) {
            $dbpath .= ',';
          }
   ...
   <form accept="products.php?<?=((isset($_GET['edit']))?'edit='.$edit_id:'add=1'); ?>" method="POST" class="" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-3">
      ...
      <button class="btn btn-default form-control" onclick="$('#Qmodal').modal('toggle'); return false;">Sizes</button>
    </div>
    <div class="form-group col-md-3">
...
<div class="modal fade" id="Qmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="updateSizes();$('#Qmodal').modal('toggle'); return false;">Save changes</button>
      </div>
    </div>
  </div>
</div><!-- End Modal -->
...
?>
   ...
   <h2 class="text-center">Products</h2>
     <a href="products.php?add=1" class="btn btn-success pull-right" id="btn-addproduct">Add Product</a><div class=""></div>
   <hr>
